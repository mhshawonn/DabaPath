...
import bannerone from "@/Images/DabaPath.png"
import bannertwo from "@/Images/chess1.jpg"
import bannerthree from "@/Images/chess2.jpg"
import bannerfour from "@/Images/chess3.jpg"
        ...
        <Slider {...settings}>
          ...
          <div className="w-full h-full relative">
            <Image
              ...
              className="w-full h-full relative"
            />
            <BannerText title="Best for Beginner" />
          </div>
          <div className="w-full h-full relative">
            <Image
              src={bannerfour}
              ...
              className="w-full h-full relative"
            />
            <BannerText title="Best product of chess" />
          </div>
        </Slider>
