    ...
    <div className="w-full bg-darkText text-slate-100">
      <Container className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div className="flex flex-col gap-y-4">
          <Logo />
          <p>
           DabaPath is first online base platform for chess lovers
          </p>
          <div className="flex items-center gap-x-4">
            <a href="https://youtube.com/@dabapath?si=shn9EleDa7e5nVPI" target="_blank">
              <span className="socialLink">
                <BsYoutube />
              </span>
            </a>
           
            <a href="https://www.linkedin.com/in/yourshawonn/" target="_blank">
              <span className="socialLink">
                <BsLinkedin />
              </span>
            </a>
            <a href="https://www.facebook.com/DabaPath?mibextid=ZbWKwL" target="_blank">
              <span className="socialLink">
                <BsFacebook />
              </span>
            </a>
        ...
        <div>
          ...
          <ul className="text-sm font-light mt-2 flex flex-col gap-y-2">
            ...
            <li className="flex flex-col">
              ...
              <span className="text-orange-600">January 31, 2025</span>
            </li>
          </ul>
        </div>
        <div>
